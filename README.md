...
| Value | 반환된 보간 값입니다. |
| Percent | 비동기 액션의 진행도 입니다. (0.0 ~ 1.0) |
...
1. 이 저장소의 최신 릴리즈에서 SourceCode.zip을 다운로드 합니다.
   - 2026.05.11 기준 v1.0.0
   - https://github.com/Youllee/UE5_Simple_Easing_Function/releases/tag/v1.0.0
3. 프로젝트의 `Plugins` 폴더에 플러그인 폴더를 복사합니다.
4. Unreal Editor를 실행합니다.
5. Plugins 창에서 `Simple Easing Function` 플러그인을 활성화합니다.
6. 프로젝트를 재시작합니다.
...
Q : 중복된 코드가 많습니다.
A : 코드 가독성과 직관성을 위해 일부러 그렇게 만들었습니다.
